            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
              ...
              >
                <div>
                  ...
                  <h2 className="mt-6 text-xl font-semibold text-gray-900 dark:text-white">
                    Izin Keluar Masuk Asrama
                  </h2>

                  <p className="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                    Silahkan klik disini untuk melakukan izin keluar masuk asrama,
                    form ini digunakan untuk melakukan pengajuan izin keluar masuk asrama.
                  </p>
                </div>
              ...
              >
                <div>
                  ...
                  <p className="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                    Silahkan klik disini untuk melakukan izin tidak mengikuti kegiatan pembelajaran,
                    form ini digunakan untuk melakukan pengajuan izin tidak mengikuti kegiatan pembelajaran.
                  </p>
                </div>
